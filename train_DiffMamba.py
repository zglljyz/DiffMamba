...
if __name__ == '__main__':
    ...
    for exp_idx,curr_seed in enumerate(seed_list):
        ...
        net = DiffMamba(in_channels=channels, num_classes=class_count, hidden_dim=128)
        ...
        best_net = DiffMamba(in_channels=channels, num_classes=class_count, hidden_dim=128)
    ...
    mean_result_path = os.path.join(save_folder, 'mean_result_tr{}_val{}.txt'.format(num_list[0], num_list[1]))

    f = open(mean_result_path, 'a+')
